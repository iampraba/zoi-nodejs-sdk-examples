Save the [code](https://github.com/iampraba/zoi-php-sdk-examples/blob/main/save_callback_implementation/express-js/save_callback.js) in a file, for example, save_callback.js.
